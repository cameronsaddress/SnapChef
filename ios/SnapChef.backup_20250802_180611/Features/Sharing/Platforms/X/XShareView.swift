...
struct XShareView: View {
    ...
    private var suggestedHashtags: [String] {
        ...
        if case .recipe(let recipe) = content.type {
            ...
            if recipe.cuisine.lowercased().contains("italian") {
                hashtags.append("ItalianFood")
            } else if recipe.cuisine.lowercased().contains("mexican") {
                hashtags.append("MexicanFood")
            } else if recipe.cuisine.lowercased().contains("asian") {
                hashtags.append("AsianCuisine")
            }
        }
