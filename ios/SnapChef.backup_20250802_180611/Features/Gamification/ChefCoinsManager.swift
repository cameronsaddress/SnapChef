...
class ChefCoinsManager: ObservableObject {
    ...
    let coinPackages: [ChefCoinsPackage] = [
        ...
        ChefCoinsPackage(coins: 1000, price: 9.99, bonusCoins: 200, isBestValue: true, productId: "com.snapchef.coins.1000"),
        ChefCoinsPackage(coins: 5000, price: 49.99, bonusCoins: 1500, isBestValue: false, productId: "com.snapchef.coins.5000")
    ]
