...
class ChallengeDatabase: ObservableObject {
    ...
    private func createSpecialChallenge(for dayOfYear: Int, baseDate: Date) -> Challenge? {
        ...
        let specialDates: [(month: Int, day: Int, template: (String, String, String, String, Int))] = [
            // January
            (1, 1, ("🎊", "New Year Fresh Start", "Create 5 healthy recipes to start the year", "healthy", 1_000)),
            ...
            // October
            (10, 31, ("🎃", "Halloween Spooktacular", "Create 5 spooky-themed recipes", "halloween", 1_000)),

            // November
            (11, 24, ("🦃", "Thanksgiving Feast", "Make 6 traditional dishes with a twist", "thanksgiving", 1_200)),

            // December
            (12, 24, ("🎄", "Holiday Magic", "Create 8 festive recipes", "christmas", 1_500)),
